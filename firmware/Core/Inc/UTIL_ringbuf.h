...
extern void UTIL_RingBufRead(tRingBufObject *ptRingBuf, uint8_t *pucData,
                        const uint32_t ulLength);
extern void UTIL_RingBufWriteOne(tRingBufObject *ptRingBuf, const uint8_t ucData);
extern void UTIL_RingBufWrite(tRingBufObject *ptRingBuf, const uint8_t *pucData,
                         const uint32_t ulLength);
extern void UTIL_RingBufAdvanceWrite(tRingBufObject *ptRingBuf,
                                const uint32_t ulNumBytes);
